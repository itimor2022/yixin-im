...
- **应用入口与配置**：`AppDelegate`、`Runner/Info.plist`、Bundle ID（`com.yixinim.app`）、应用名「潮商会」、版本与权限文案等。
...
| **Bundle ID / 应用名** | Xcode 中 PRODUCT_BUNDLE_IDENTIFIER（如 com.yixinim.app）；Info.plist 中 CFBundleName/CFBundleDisplayName「潮商会」。 |
