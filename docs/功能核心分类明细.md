...
- `docs/project/PROJECT_STRUCTURE.md`: 目录结构与功能说明书
...
## 8) 音视频通话（Agora / LiveKit：发起/接听/挂断/来电）
**后端**
...
- `backend/internal/services/livekit_service.go`: LiveKit Token/配置获取

**客户端**
- `lib/core/services/call_service.dart`: Agora/LiveKit/CallKit 业务封装
